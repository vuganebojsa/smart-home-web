...
import { RegisterAmbientSensorDTO } from 'src/app/shared/models/AmbientSensor';
import { TypeOfPowerSupply } from 'src/app/shared/models/PowerSupply';
import { SnackbarService } from 'src/app/core/services/snackbar.service';

@Component({
  selector: 'app-register-ambient-sensor',
  templateUrl: './register-ambient-sensor.component.html',
  styleUrls: ['./register-ambient-sensor.component.css']
})
export class RegisterAmbientSensorComponent {
  ...
  register() {
    ...
    var ambientSensor: RegisterAmbientSensorDTO = {
    ...
    this.smartDeviceService.registerAmbientSensor(ambientSensor).subscribe({
      next: (res) =>{
