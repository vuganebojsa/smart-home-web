...
@Component({
  selector: 'app-smart-property-report',
  templateUrl: './smart-property-report.component.html',
  styleUrls: ['./smart-property-report.component.css']
})
export class SmartPropertyReportComponent implements OnInit{
          ...
          tooltip: {
            callbacks: {
              ...
              label:  (tooltipItem) => {
                ...
                return `The property ${type}: ${this.tooltipProduced[index].consumedValues} KW`;
              }
            }
          }
        }
        ...
        plugins: {
          tooltip: {
            callbacks: {
              ...
              label:  (tooltipItem) => {
                const index = tooltipItem.dataIndex;
                return `The property ${type}: ${this.tooltipNonRealTimeData[index].consumedValues} KW`;
              }
            }
          }
        }
  ...
  submit(){
    ...
    this.service.getEnergyConsumedInPropertyInRange(this.name, start, end, true).subscribe({
      next:(res) =>{
        this.consumed = res;
    ...
    this.service.getEnergyConsumedInPropertyInRange(this.name, start, end, false).subscribe({
      next:(res) =>{
        this.produced = res;
  ...
  searchByTime(totalTimePeriod: TotalTimePeriod){
    ...
    this.service.getEnergyConsumedInPropertyByTimePeriod(this.name, totalTimePeriod, true).subscribe({
      next:(result) =>{
    ...
    this.service.getEnergyConsumedInPropertyByTimePeriod(this.name, totalTimePeriod, false).subscribe({
      next:(result) =>{
